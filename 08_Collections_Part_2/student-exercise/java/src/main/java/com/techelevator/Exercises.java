...
public class Exercises {
	...
	public String animalGroupName(String animalName) {
		...
		String wantAnimalGroup = animalGroupName.get(animalName);
		
		if (wantAnimalGroup == null) {
			return "unknown";
		}
		return wantAnimalGroup;
		}
	...
	public double isItOnSale(String itemNumber) {
		...
		Double discountPrice = discount.get(itemNumber);
	...
	public Map<String, Integer> peterPaulPartnership(Map<String, Integer> peterPaul) {
		...
		int peterMoney = peterPaul.get("Peter");			//Peter and Paul's money value
		int paulMoney = peterPaul.get("Paul");
	...
	public Map<Integer, Integer> integerCount(int[] ints) {
		...
		for (int integerNum : ints) {
			
			if (counts.containsKey(integerNum)) {
				int currentCount = counts.get(integerNum);
				currentCount++;
				
				counts.put(integerNum, currentCount);
			}
			else {
				counts.put(integerNum, 1);
			}
		}
	...
	public Map<String, Integer> consolidateInventory(Map<String, Integer> mainWarehouse, Map<String, Integer> remoteWarehouse) {
		...
		Map<String, Integer> conInv = new HashMap<String, Integer>();
		
		for(String value : mainWarehouse.keySet()) {
			if(remoteWarehouse.containsKey(value)) {
				conInv.put(value, (mainWarehouse.get(value) + remoteWarehouse.get(value)));
			}
			else {
				conInv.put(value, mainWarehouse.get(value));
			}
		}
		for(String value : remoteWarehouse.keySet()) {
			if(!(mainWarehouse.containsKey(value))) {
				conInv.put(value, remoteWarehouse.get(value));
			}
		}
