	...
	public static void main(String[] args) throws IOException {
		...
		if(userPath.exists()) {
			...
			if(userPath.isDirectory()) {
				...
				System.out.println(userPath.getName() + " is neither a file or a directory. But, the parent is: " + userPath.getParent());
			}
		...
		if(!newDirectory.exists()) {
			System.out.println("Creating directory : " + newDirectoryName);
		...
		if (newFile.createNewFile()){
			...
			System.out.println("File Length : " + newFileName.length());
		 ...
		 * ********************/
		System.out.println("---------------\n");
		System.out.println("Enter data to add to the file");
