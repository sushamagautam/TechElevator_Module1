	...
	public static void main(String[] args) {
		...
		try {
			...
			for (int i = 0; i<= cityCount; i++) {
				cityProcessing = i;
				System.out.println("I love " + cities[i]);
			}
			System.out.println("are all in Ohio."); //this line won't execute because the previous throws an error 
			...
			System.out.println("I was trying to print city # " + (cityProcessing + 1) + " and it failed");
		}
		catch(NullPointerException exNPE) {
			// Flow of control resumes here after the Exception is thrown
			System.out.println("WHOA!! you can't do that to a non instantiated object!");
		}
		catch(Exception ex) {
